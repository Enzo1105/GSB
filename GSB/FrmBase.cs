...
namespace GSB {
    public partial class FrmBase : Form {
        ...
        private void modifierRendezVous_Click(object sender, EventArgs e) {
            FrmVisiteModification unFrmVisiteModification = new FrmVisiteModification();
            unFrmVisiteModification.Show();
            Close();
        ...
        private void imprimerRendezvous_Click(object sender, EventArgs e) {
            FrmImpressionRendezVous unFrmRdvImpression = new FrmImpressionRendezVous();
            unFrmRdvImpression.Show();
            Close();
        ...
        private void enregistrerBilan_Click(object sender, EventArgs e) {
            FrmVisiteBilanAjout unFrmVisiteBilanAjout = new FrmVisiteBilanAjout();
            unFrmVisiteBilanAjout.Show();
            Close();
        ...
        private void consulterVisite_Click(object sender, EventArgs e) {
            FrmVisiteConsultation unFrmVisiteConsultation = new FrmVisiteConsultation();
            unFrmVisiteConsultation.Show();
            Close();
        }

        // consultation des médicaments
        private void ficheMédicamentToolStripMenuItem_Click(object sender, EventArgs e) {
            FrmFicheMedicament unFrmMedicaments = new FrmFicheMedicament();
            unFrmMedicaments.Show();
            Close();
        ...
        private void modifierPraticien_Click(object sender, EventArgs e) {
            FrmMajPraticien unFrmMajPraticien = new FrmMajPraticien();
            unFrmMajPraticien.Show();
            Close();
